        ...
        <button
          ...
          className={
            isPill
              ...
              : isCompact
                ? "rounded-full border border-white/10 bg-white/[0.045] px-3 py-1.5 text-sm text-white/62 transition-colors hover:border-chat-accent/30 hover:bg-white/[0.075] hover:text-white active:scale-[0.98]"
